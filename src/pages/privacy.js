...
const Privacy = () => {
            ...
            <div className="row justify-content-left">
              <div className="col-xl-11">
                ...
                <div className="text-left pb-0">
                  ...
                  <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.strategically.co (the “Site”).</p>

  <h3 className="text-dark-cloud">Personal information we collect</h3>
  ...
  <h3 className="text-dark-cloud">How do we use your personal information?</h3>
  ...
  <h3 className="text-dark-cloud">Sharing your personal information</h3>
  <p>We share your Personal Information with third parties to help us use your Personal Information, as described above. For example, we use Zoho Subscriptions to power our online store. We also use Google Analytics to help us understand how our customers use the Site -- you can read more about how Google uses your Personal Information here: https://www.google.com/intl/en/policies/privacy/. </p>
  ...
  <h3 className="text-dark-cloud">Behavioural advertising</h3>
  ...
  <h3 className="text-dark-cloud">Do not track</h3>
  <p>Please note that we do not alter our Site’s data collection and use practices when we see a Do Not Track signal from your browser.</p>

  <h3 className="text-dark-cloud">Your rights</h3>
  ...
  <h3 className="text-dark-cloud">Data retention</h3>
  <p>When you place an order through the Site, we will maintain your Order Information for our records unless and until you ask us to delete this information.</p>

  <h3 className="text-dark-cloud">Changes</h3>
  <p>We may update this privacy policy from time to time in order to reflect, for example, changes to our practices or for other operational, legal or regulatory reasons.</p>

  <h3 className="text-dark-cloud">Minors</h3>
  <p>The Site is not intended for individuals under the age of 18.</p>

  <h3 className="text-dark-cloud">Contact us</h3>
  <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at hello@strategically.co or by mail using the details provided below:</p>

  <p>Strategically Digital Marketing Ltd</p>
  <p>[Re: Privacy Compliance Officer]</p>
  <p>www.strategically.co, 454 Long Lane, London, N28JL, United Kingdom</p>
